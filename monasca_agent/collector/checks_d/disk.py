    ...
    def check(self, instance):
                ...
                if send_io_stats:
                    try:
                        ...
                        self.rate("io.read_req_sec", round(float(stats.read_count), 2),
                                  device_name=device_name, dimensions=dimensions, delegated_tenant=self.delegated_tenant_id)
        ...
        if send_rollup_stats:
            self.gauge("disk.total_space_mb",
                       ...
                       dimensions=rollup_dimensions, delegated_tenant=self.delegated_tenant_id)
